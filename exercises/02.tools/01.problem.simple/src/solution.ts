...
server.registerTool(
	...
	{
		//user-facing title
		title: 'Add the numbers one and two',
		//llm-facing description & possibly user-facing description - 
		// these are the situations where the tool can be used - 
		 // be descriptive of what your tool can do, include examples of, like, if you give me these parameters, then this is what's going to happen
		description: 'Add the numbers 1 and 2 ',
	},
	async () => {
		return {
			// types of content - text, image, audio, video, and resources.
